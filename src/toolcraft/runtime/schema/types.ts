...
export type ToolcraftControlSectionSchema = {
  ...
  // "setup" folds the section's controls into the runtime Setup block after
  // Resolution scale instead of rendering a collapsible section of its own, for
  // app settings that belong with the runtime's own view/output settings.
  placement?: "setup";
  title?: string;
  visibleWhen?: ToolcraftControlConditionSchema;
};
